...
public class WebDriverUtility {
	...
	{
		//driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10), TimeUnit.MILLISECONDS);
	}
	/**
	...
	{
		//WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(IConstants.explicitWaitDuration));
				//new WebDriverWait(driver,Duration.ofSeconds(IConstants.explicitWaitDuration));
...
//		wait.until(ExpectedConditions.urlContains(URL));
	...
	/**
	 * this method will ignore the no such element exception for the particular duration
	 * @param driver
	 */
